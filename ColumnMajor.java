//Traversing 2D arrays: Column Major traversal
    ...
    // Given runner lap data
      ...
      {72.653, 77.649, 74.245, 62.121, 63.379, 79.354}};
        ...
        lapTime += times[inner][outer];
			...
			System.out.println("Sum of lap " + outer + " times: " + String.format("%.2f", lapTime));
			System.out.println("Average time for lap " + outer + ": " + String.format("%.2f", averageVal) + "\n");
		}
	}
}
